...
//Task: Даден е двумерен масив А[n][m].Напишете програма която намира сумата на
//      елементите с отрицателна стойност, разположени на редове с нечетни индекси.N, M и
...
int main() {
	...
	// обхождане на елементите които са на редове с нечетни индекси на двумерния масив
	...
	std::cout << "The sum of negative-values numbers on rows with odd indices is: "
		<< sum << std::endl;
