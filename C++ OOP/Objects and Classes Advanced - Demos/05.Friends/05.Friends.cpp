...
public:
    ...
    void print() {
        std::cout << this->id << " (" << this->capitalDollars 
            << ")" << std::endl;
    }
...
// NOTE: it's actually good practice to define such parsing functions as members of the parsed class, 
// but we're doing it this way to ease the transition to operator overloading later
