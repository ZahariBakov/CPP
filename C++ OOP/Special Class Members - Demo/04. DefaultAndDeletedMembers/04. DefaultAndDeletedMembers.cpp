...
// NOTE: replacing the signature with the commented-out signature will cause
//      a compilation error in calls due to IntArray not being copyable
...
int main() {
    ...
    Lecturer copyAssigmentLecturer = copyInitializedLEcturer;

    std::cout << copyAssigmentLecturer.getName() << " "
              << copyAssigmentLecturer.getRating() << std::endl;
