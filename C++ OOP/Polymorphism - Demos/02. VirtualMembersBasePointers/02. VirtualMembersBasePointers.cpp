...
int main() {
    ...
    // calls Airplane::toString() due to override
    ...
    // calls Car::toString() due to override
    std::cout << v->toString() << std::endl;
    ...
    // calls StaticPlaygroundTrain::toString() due to override
    std::cout << v->toString() << std::endl;

    // calls Vehicle::toString() because there is no override
    // for stop() in StaticPlaygroundTrain
    v->stop();
    std::cout << v->toString() << std::endl;
