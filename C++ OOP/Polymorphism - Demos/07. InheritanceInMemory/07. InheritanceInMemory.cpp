...
public:
    ...
    Spider(int numLegs, float weight) : Organism(weight, false, true), numLegs(numLegs) {}
};
...
int main() {
    ...
    // NOTE: cow has an actual size of 6 bytes, but padding/alignment
    //will cause it to grow to next power of 2, which is 8 in this case.
